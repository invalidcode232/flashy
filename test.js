...
var flashcard_repo_1 = require("./src/repos/flashcard-repo");
var test = function () { return __awaiter(void 0, void 0, void 0, function () {
    var flashcard, flashcardData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                flashcard = new flashcard_repo_1["default"]('What is 1+1', 100, {
                    is_multiple: true,
                    answer: '2',
                    wrong_answer_1: '3',
                    wrong_answer_2: '-1',
                ...
                return [4 /*yield*/, flashcard.save()];
            case 1:
                flashcardData = (_a.sent()).data;
                if (!flashcardData) {
